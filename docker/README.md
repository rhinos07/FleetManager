...
| Seq Log-UI | http://localhost:5342 | `monitoring` |
...
Öffne **http://localhost:5342** — alle Logs von Fleet Controller und AGV-Simulator landen dort durchsuchbar mit Filtern nach `VehicleId`, `OrderId`, Log-Level etc.
